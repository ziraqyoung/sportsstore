...
export const CartReducer = (storeData, action) => {
  ...
  switch (action.type) {
    ...
    /*
     *TODO: This may raise an issue
     * =====> Action creator accepts an ID removeFromCart(products)
     * but ====> the reducer expects an ID
     * */
    ...
    case ActionTypes.CART_CLEAR:
      return { ...storeData, cart: [], cartPrice: 0, cartItems: 0 };
